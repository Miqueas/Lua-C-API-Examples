...
/* In this example, we load a Lua file which contains
 * a table and use it as a "configuration" file
 */
...
int main(int argc, char **argv) {
  ...
  // This compile time have the path in where the file is, this is
  // to prevent to hardcode it. Is defined in the "constants.h"
  // header, which is generated by meson
  ...
  if (err) {
    ...
    // that means, the last pushed item in the stack (the string "verbose"). But
